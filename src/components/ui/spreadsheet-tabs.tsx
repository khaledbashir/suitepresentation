...
const SortableTabItem: React.FC<{
  ...
  return (
    <div
      ...
      className={cn(
        "spreadsheet-tab group px-3 py-1.5 text-xs whitespace-nowrap flex items-center gap-1 rounded-t transition-all duration-150",
        isActive && "active",
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "spreadsheet-tabs flex items-center overflow-x-auto px-2 py-1 gap-1 border-t border-border",
            "[&::-webkit-scrollbar]:w-[6px]",
            "[&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600",
            "[&::-webkit-scrollbar:horizontal]:h-[4px]",
          )}
