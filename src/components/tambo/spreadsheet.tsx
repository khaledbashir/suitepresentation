  ...
  ({
    ...
    if (!rows || rows.length === 0 || !columns || columns.length === 0) {
      return (
        ...
        >
          <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground p-8 gap-4 spreadsheet-empty-state">
            <div className="text-center space-y-2">
              <h3 className="text-lg font-semibold text-foreground">No Data Available</h3>
              <p className="text-sm max-w-md spreadsheet-empty-state">
    ...
    return (
      ...
      >
        ...
        {/* Spreadsheet grid with smart auto-theme container */}
        <div 
          ref={containerRef}
          className="flex-1 overflow-auto spreadsheet-container"
        >
