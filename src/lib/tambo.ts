...
// import { blocksuiteTools } from "@/tools/blocksuite-tools"; // TODO: Update to v0.58.1 format (tool + toolSchema)
...
export const tools: TamboTool[] = [
  ...spreadsheetTools,
  ...tabTools,
  // ...blocksuiteTools, // Temporarily disabled - needs format update for v0.58.1
  ...artifactTools,
];
