...
<ImageZoom src="/assets/docs/template.gif" alt="Demo GIF" width={500} height={500} style={{ border: "2px solid #e5e7eb", borderRadius: "8px", width: "80%" }} />
...
<ImageZoom src="/assets/docs/recipe-gen.png" alt="usage of RecipeCard" width={500} height={500} style={{ border: "2px solid #e5e7eb", borderRadius: "8px", width: "80%" }} />
...
<ImageZoom src="/assets/docs/add-a-tool.png" alt="usage of a tool" width={500} height={500} style={{ border: "2px solid #e5e7eb", borderRadius: "8px", width: "80%" }} />
